...
type SrpmArchiverClient interface {
	...
	SealBatch(ctx context.Context, in *SealBatchRequest, opts ...grpc.CallOption) (*longrunning.Operation, error)
	// Returns an entry
...
func (c *srpmArchiverClient) SealBatch(ctx context.Context, in *SealBatchRequest, opts ...grpc.CallOption) (*longrunning.Operation, error) {
	out := new(longrunning.Operation)
	err := c.cc.Invoke(ctx, "/mothership.v1.SrpmArchiver/SealBatch", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SrpmArchiverServer interface {
	...
	// Seal a batch
	// Only worker credentials can seal a batch.
	SealBatch(context.Context, *SealBatchRequest) (*longrunning.Operation, error)
	// Returns an entry
...
func _SrpmArchiver_SealBatch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SealBatchRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SrpmArchiverServer).SealBatch(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mothership.v1.SrpmArchiver/SealBatch",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SrpmArchiverServer).SealBatch(ctx, req.(*SealBatchRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SrpmArchiver_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _SrpmArchiver_SealBatch_Handler,
		},
		{
			MethodName: "GetEntry",
